(() => {
    ...
    var Ci = Object.getPrototypeOf, Ti = Object.prototype.hasOwnProperty;
    var Pi = (l, h) => () => (h || l((h = {exports: {}}).exports, h), h.exports);
    var xi = (l, h, a, c) => {
        if (h && typeof h == "object" || typeof h == "function") for (let s of Si(h)) !Ti.call(l, s) && s !== a && he(l, s, {
            get: () => h[s],
            enumerable: !(c = ki(h, s)) || c.enumerable
        });
        return l
    };
    var Oi = (l, h, a) => (a = l != null ? wi(Ci(l)) : {}, xi(h || !l || !l.__esModule ? he(a, "default", {
        value: l,
        enumerable: !0
    }) : a, l));
    var ge = Pi((dt, It) => {
        (function (h, a) {
            typeof dt == "object" && typeof It == "object" ? It.exports = a() : typeof define == "function" && define.amd ? define([], a) : typeof dt == "object" ? dt.Pusher = a() : h.Pusher = a()
        })(window, function () {
            return function (l) {
                var h = {};
                ...
                var c = this && this.__extends || function () {
                    var m = function (v, y) {
                        return m = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (w, O) {
                            w.__proto__ = O
                        } || function (w, O) {
                ...
                var s = 256, f = function () {
                    ...
                    return m.prototype.encodedLength = function (v) {
                ...
                h.decodeURLSafe = x, h.encodedLength = function (m) {
                    ...
                    for (var T = [], S = 0; S < P.length; S++) {
                        ...
                        if (C & 128) {
                            ...
                            if (C < 224) {
                                ...
                                var m = P[++S], v = P[++S], y = P[++S];
                                if ((m & 192) !== 128 || (v & 192) !== 128 || (y & 192) !== 128) throw new Error(s);
                                C = (C & 15) << 18 | (m & 63) << 12 | (v & 63) << 6 | y & 63, x = 65536
                ...
                var c = function () {
                    ...
                    return e.prototype.load = function (t, n, r) {
                        ...
                        if (i.loading[t] && i.loading[t].length > 0) i.loading[t].push(r); else {
                            i.loading[t] = [r];
                            var o = b.createScriptRequest(i.getPath(t, n)), u = i.receivers.create(function (p) {
                        ...
                        var n, r = b.getDocument().location.protocol;
                        ...
                        if (o.readyState === 4) if (o.status === 200) {
                            ...
                            switch (r) {
                                ...
                                case v.ChannelAuthorization:
                                    k = "Clients must be authorized to join private or presence channels. " + m.buildLogSuffix("authorizationEndpoint");
                                    break
                            }
                ...
                for (var nt = String.fromCharCode, Z = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", ke = {}, st = 0, Se = Z.length; st < Se; st++) ke[Z.charAt(st)] = st;
                var Ce = function (e) {
                ...
                var Q = function (e) {
                    ...
                    function t(n, r) {
                        return e.call(this, setTimeout, Ae, n, function (i) {
                            return r(), null
                        }) || this
                    }
                ...
                function Ie() {
                    for (var e = ["Pusher"], t = 0; t < arguments.length; t++) typeof arguments[t] == "string" ? e.push(arguments[t]) : e.push(at(arguments[t]));
                    return e.join(" : ")
                }
                ...
                function De(e) {
                    return Ne(e, function (t) {
                        return typeof t == "object" && (t = at(t)), encodeURIComponent(we(t.toString()))
                    })
                }
                ...
                var ze = function () {
                    ...
                    return e.prototype.debug = function () {
                        ...
                        if (Tt.log) Tt.log(i); else if (Tt.logToConsole) {
                            var o = t.bind(this);
                            o(i)
                        }
                    }, e
                }(), A = new ze, Fe = function (e, t, n, r, i) {
                    ...
                    return e.prototype.send = function (t) {
                        if (!this.request) {
                            var n = He(this.data), r = this.url + "/" + t.number + "?" + n;
                            this.request = b.createScriptRequest(r), this.request.send(t)
                        }
                    }, e.prototype.cleanup = function () {
                        this.request && this.request.cleanup()
                    }, e
                }(), Ve = We, Ge = function (e, t) {
                    return function (n, r) {
                        var i = "http" + (t ? "s" : "") + "://", o = i + (e.host || e.options.host) + e.options.path,
                            u = b.createJSONPRequest(o, n), p = b.ScriptReceivers.create(function (_, g) {
                                s.remove(p), u.cleanup(), g && g.host && (e.host = g.host), r && r(_, g)
                            });
                        u.send(p)
                    }
                }, Qe = {name: "jsonp", getAgent: Ge}, Ke = Qe;
                ...
                var nn = function () {
                        function e(t) {
                            this.callbacks = new en, this.global_callbacks = [], this.failThrough = t
                        }
                        ...
                        function t(n, r, i, o, u) {
                            ...
                            return p.initialize = b.transportConnectionInitializer, p.hooks = n, p.name = r, p.priority = i, p.key = o, p.options = u, p.state = "new", p.timeline = u.timeline, p.activityTimeout = u.activityTimeout, p.id = p.timeline.generateUniqueID(), p
                        }
                        ...
                        urls: Ye, handlesActivityChecks: !1, supportsPing: !1, isInitialized: function () {
                        ...
                        urls: $e, handlesActivityChecks: !1, supportsPing: !0, isInitialized: function () {
                            return !0
                        }
                    }, Bt = U({
                        getSocket: function (e) {
                    ...
                    }, un = new tt(U({}, Bt, Jt)), hn = new tt(U({}, Xt, Jt)),
                    ln = {ws: cn, xhr_streaming: un, xhr_polling: hn}, ct = ln, fn = new tt({
                        file: "sockjs",
                        urls: Ze,
                    ...
                    }, pn = new tt(U({}, Bt, Wt)), dn = new tt(U({}, Xt, Wt));
                ct.xdr_streaming = pn, ct.xdr_polling = dn, ct.sockjs = fn;
                var vn = ct, yn = function () {
                    var e = function (t, n) {
                        return e = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (r, i) {
                            r.__proto__ = i
                        } || function (r, i) {
                    ...
                    return e.prototype.createConnection = function (t, n, r, i) {
                        ...
                        var u = this.transport.createConnection(t, n, r, i), p = null, _ = function () {
                            ...
                            if (u.unbind("closed", g), k.code === 1002 || k.code === 1003) o.manager.reportDeath(); else if (!k.wasClean && p) {
                                var L = j.now() - p;
                                L < 2 * o.maxPingDelay && (o.manager.reportDeath(), o.pingDelay = Math.max(L / 2, o.minPingDelay))
                            }
                        };
                    ...
                    return e.prototype.send = function (t, n) {
                        this.timeline.isEmpty() || this.timeline.send(b.TimelineTransport.getAgent(this, t), n)
                    }, e
                }(), xn = Pn, On = function () {
                    var e = function (t, n) {
                        return e = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (r, i) {
                            ...
                            return Nn(i, void 0, void 0, function () {
                                ...
                                return qn(this, function (g) {
                                    switch (g.label) {
                                        ...
                                        case 2:
                                            if (g.sent(), this.pusher.user.user_data != null) this.members.setMyID(this.pusher.user.user_data.id); else return _ = m.buildLogSuffix("authorizationEndpoint"), A.error("Invalid auth response for channel '" + this.name + "', " + ("expected 'channel_data' field. " + _ + ", ") + "or the user should be signed in."), r("Invalid auth response"), [2];
                                            g.label = 3;
                                        case 3:
                                            return r(o, u), [2]
                                    }
                ...
                }(mt), Dn = Un, Hn = a(1), bt = a(0), Mn = function () {
                    var e = function (t, n) {
                        return e = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (r, i) {
                            r.__proto__ = i
                        } || function (r, i) {
                    ...
                    return t.prototype.authorize = function (n, r) {
                        ...
                        e.prototype.authorize.call(this, n, function (o, u) {
                            ...
                            i.key = Object(bt.decode)(p), delete u.shared_secret, r(null, u)
                        })
                    }, t.prototype.trigger = function (n, r) {
                    ...
                    return e.prototype.add = function (t, n) {
                        return this.channels[t] || (this.channels[t] = Gn(t, n)), this.channels[t]
                ...
                var nr = function () {
                    ...
                    return e.prototype.isSupported = function () {
                        ...
                        var r = this.usingTLS, i = ir(r), o = [this.strategy];
                        ...
                        var p = j.now(), _ = o.pop().connect(t, function g(k, L) {
                            k ? (Qt(r), o.length > 0 ? (p = j.now(), _ = o.pop().connect(t, g)) : n(k)) : (or(r, L.transport.name, j.now() - p), n(null, L))
                        });
                        return {
                            abort: function () {
                                _.abort()
                ...
                var hr = function (e, t, n) {
                    ...
                    var o = Object.assign({}, t, {
                        ...
                        L = i("ws", "ws", 3, o, g), X = i("wss", "ws", 3, u, g), fi = i("sockjs", "sockjs", 1, p),
                        ne = i("xhr_streaming", "xhr_streaming", 1, p, k),
                        pi = i("xdr_streaming", "xdr_streaming", 1, p, k), re = i("xhr_polling", "xhr_polling", 1, p),
                        di = i("xdr_polling", "xdr_polling", 1, p), ie = new Y([L], _), vi = new Y([X], _),
                        yi = new Y([fi], _), oe = new Y([new it(ot(ne), ne, pi)], _),
                        se = new Y([new it(ot(re), re, di)], _),
                        ae = new Y([new it(ot(oe), new wt([oe, new ut(se, {delay: 4e3})]), se)], _),
                        Pt = new it(ot(ae), ae, yi), xt;
                    return t.useTLS ? xt = new wt([ie, new ut(Pt, {delay: 2e3})]) : xt = new wt([ie, new ut(vi, {delay: 2e3}), new ut(Pt, {delay: 5e3})]), new rr(new ur(new it(ot(L), xt, Pt)), r, {
                        ttl: 18e5,
                        timeline: t.timeline,
                        useTLS: t.useTLS
                    })
                    ...
                    return t.prototype.start = function (n) {
                        ...
                        this.position = 0, this.xhr = this.hooks.getRequest(this), this.unloader = function () {
                            r.close()
                        }, b.addUnloadListener(this.unloader), this.xhr.open(this.method, this.url, !0), this.xhr.setRequestHeader && this.xhr.setRequestHeader("Content-Type", "application/json"), this.xhr.send(n)
                    }, t.prototype.close = function () {
...
`);
                ...
                var $ = St, mr = 1, br = function () {
                    function e(t, n) {
                        this.hooks = t, this.session = Yt(1e3) + "/" + Cr(8), this.location = wr(n), this.readyState = $.CONNECTING, this.openStream()
                    }
                    ...
                    return e.prototype.send = function (t) {
                        ...
                        if (this.readyState === $.OPEN) try {
                            return b.createSocketRequest("POST", Kt(kr(this.location, this.session))).start(t), !0
                        } catch {
                            return !1
                        } else return !1
                        ...
                        this.readyState === $.CONNECTING ? (t && t.hostname && (this.location.base = Sr(this.location.base, t.hostname)), this.readyState = $.OPEN, this.onopen && this.onopen()) : this.onClose(1006, "Server lost session", !0)
                        ...
                        var t = this;
                        this.stream = b.createSocketRequest("POST", Kt(this.hooks.getReceiveURL(this.location, this.session))), this.stream.bind("chunk", function (n) {
                            t.onChunk(n)
                ...
                var Hr = b.Transports, Mr = function (e, t, n, r, i, o) {
                    var u = Hr[n];
                    if (!u) throw new F(n);
                    var p = (!e.enabledTransports || qt(e.enabledTransports, t) !== -1) && (!e.disabledTransports || qt(e.disabledTransports, t) === -1),
                        _;
                    return p ? (i = Object.assign({ignoreNullOrigin: e.ignoreNullOrigin}, i), _ = new Dr(t, r, o ? o.getAssistant(u) : u, i)) : _ = zr, _
                }, zr = {
                    isSupported: function () {
                        return !1
                ...
                function ei(e, t) {
                    ...
                    }, "auth" in e && ("params" in e.auth && (n.params = e.auth.params), "headers" in e.auth && (n.headers = e.auth.headers)), "authorizer" in e && (n.customHandler = Gr(t, n, e.authorizer))), n
                }

                function ni(e, t) {
                    var n = ei(e, t);
                    return "customHandler" in n && n.customHandler != null ? n.customHandler : Vr(n)
                }
                ...
                var ai = si, ci = function () {
                    ...
                    function t(n) {
                        ...
                        }), r.watchlist = new oi(n), r.pusher.connection.bind("message", function (i) {
                            var o = i.event;
                    ...
                    return t.prototype.signin = function () {
                        ...
                        this.serverToUserChannel = new _t("#server-to-user-" + this.user_data.id, this.pusher), this.serverToUserChannel.bind_global(function (i, o) {
                        ...
                        if (this.signin_requested && !(this.signinDonePromise && !this.signinDonePromise.done)) {
                            var n = ai(), r = n.promise, i = n.resolve, o = n.reject;
                            r.done = !1;
                            var u = function () {
                                r.done = !0
                            };
                    ...
                    function e(t, n) {
                        var r = this;
                        if (li(t), n = n || {}, !n.cluster && !(n.wsHost || n.httpHost)) {
                            var i = m.buildLogSuffix("javascriptQuickStart");
                            A.warn("You should always specify a cluster when connecting. " + i)
                        }
                        "disableStats" in n && A.warn("The disableStats option is deprecated in favor of enableStats"), this.key = t, this.config = Qr(n, this), this.channels = G.createChannels(), this.global_emitter = new V, this.sessionID = b.randomInt(1e9), this.timeline = new qr(this.key, this.sessionID, {
                        ...
                        this.connection = G.createConnectionManager(this.key, {
                            ...
                            A.warn(u)
                        }), e.instances.push(this), this.timeline.info({instances: e.instances.length}), this.user = new hi(this), e.isReady && this.connect()
                    }
                    ...
                    return e.ready = function () {
                        ...
                        return Ut(Mt({ws: b.Transports.ws}, function (t) {
                            return t.isSupported({})
                        }))
                        ...
                        this.user.signin()
                    }, e.instances = [], e.isReady = !1, e.logToConsole = !1, e.Runtime = b, e.ScriptReceivers = b.ScriptReceivers, e.DependenciesReceivers = b.DependenciesReceivers, e.auth_callbacks = b.auth_callbacks, e
                }(), Tt = h.default = ee;
    ...
    function Ot(l) {
        ...
        return Ot = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (h) {
            return typeof h
        } : function (h) {
    ...
    function D(l, h) {
        ...
        }), Object.defineProperty(l, "prototype", {writable: !1}), h && Lt(l, h)
    }

    function lt(l) {
        return lt = Object.setPrototypeOf ? Object.getPrototypeOf : function (a) {
            return a.__proto__ || Object.getPrototypeOf(a)
        }, lt(l)
    }

    function Lt(l, h) {
        return Lt = Object.setPrototypeOf || function (c, s) {
    ...
    var Et = function () {
        ...
        return R(l, [{
            key: "format", value: function (a) {
                return a.charAt(0) === "." || a.charAt(0) === "\\" ? a.substr(1) : (this.namespace && (a = this.namespace + "." + a), a.replace(/\./g, "\\"))
            }
        }, {
        ...
        function a(c, s, f) {
            var d;
            return E(this, a), d = h.call(this), d.name = s, d.pusher = c, d.options = f, d.eventFormatter = new pe(d.options.namespace), d.subscribe(), d
        }
        ...
        function a(c, s, f) {
            var d;
            return E(this, a), d = h.call(this), d.events = {}, d.listeners = {}, d.name = s, d.socket = c, d.options = f, d.eventFormatter = new pe(d.options.namespace), d.subscribe(), d
        }
        ...
        return R(a, [{
            ...
            key: "channel", value: function (s) {
                return this.channels[s] || (this.channels[s] = new pt(this.pusher, s, this.options)), this.channels[s]
            }
        }, {
            key: "privateChannel", value: function (s) {
                return this.channels["private-" + s] || (this.channels["private-" + s] = new Ri(this.pusher, "private-" + s, this.options)), this.channels["private-" + s]
            }
        }, {
            key: "encryptedPrivateChannel", value: function (s) {
                return this.channels["private-encrypted-" + s] || (this.channels["private-encrypted-" + s] = new Ii(this.pusher, "private-encrypted-" + s, this.options)), this.channels["private-encrypted-" + s]
            }
        }, {
            key: "presenceChannel", value: function (s) {
                return this.channels["presence-" + s] || (this.channels["presence-" + s] = new ji(this.pusher, "presence-" + s, this.options)), this.channels["presence-" + s]
            }
        }, {
        ...
        return R(a, [{
            ...
            key: "channel", value: function (s) {
                return this.channels[s] || (this.channels[s] = new de(this.socket, s, this.options)), this.channels[s]
            }
        }, {
            key: "privateChannel", value: function (s) {
                return this.channels["private-" + s] || (this.channels["private-" + s] = new ve(this.socket, "private-" + s, this.options)), this.channels["private-" + s]
            }
        }, {
            key: "presenceChannel", value: function (s) {
                return this.channels["presence-" + s] || (this.channels["presence-" + s] = new Ni(this.socket, "presence-" + s, this.options)), this.channels["presence-" + s]
            }
        }, {
            key: "leave", value: function (s) {
        ...
        function l(h) {
            E(this, l), this.options = h, this.connect(), this.options.withoutInterceptors || this.registerInterceptors()
        }
        ...
        return R(l, [{
            ...
            key: "connect", value: function () {
                this.options.broadcaster == "pusher" ? this.connector = new Ui(this.options) : this.options.broadcaster == "socket.io" ? this.connector = new Di(this.options) : this.options.broadcaster == "null" ? this.connector = new Hi(this.options) : typeof this.options.broadcaster == "function" && (this.connector = new this.options.broadcaster(this.options))
            }
        }, {
            key: "disconnect", value: function () {
            ...
            key: "registerInterceptors", value: function () {
                typeof Vue == "function" && Vue.http && this.registerVueRequestInterceptor(), typeof axios == "function" && this.registerAxiosRequestInterceptor(), typeof jQuery == "function" && this.registerjQueryAjaxSetup(), (typeof Turbo > "u" ? "undefined" : Ot(Turbo)) === "object" && this.registerTurboRequestInterceptor()
            }
        }, {
